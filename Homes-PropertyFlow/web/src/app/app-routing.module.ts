...
const appRoutes: Routes = [
  ...
  // search result page layout: Start
  {
    ...
    children: [
      {
        path: "buyer", 
        loadChildren: "./pages/buyer/buyer-read-more/buyer-read-more.module#BuyerReadMoreModule",
        // canActivate: [AuthGuard],
        // data: { roles: ["Admin"] }
      },
      {
        path: "buyer/:pageName/:RandomNo", 
        loadChildren: "./pages/buyer/buyer-read-more/buyer-read-more.module#BuyerReadMoreModule",
        // canActivate: [AuthGuard],
        // data: { roles: ["Admin"] }
      },
      {
        path: "seller", 
        loadChildren: "./pages/seller/seller-read-more/seller-read-more.module#SellerReadMoreModule",
        // canActivate: [AuthGuard],
        // data: { roles: ["Admin"] }
      },
      {
        path: "seller/:pageName/:RandomNo", 
        loadChildren: "./pages/seller/seller-read-more/seller-read-more.module#SellerReadMoreModule",
        // canActivate: [AuthGuard],
        // data: { roles: ["Admin"] }
      },
      {
        path: "agent", 
        loadChildren: "./pages/agent-pages/agent-read-more/agent-read-more.module#AgentReadMoreModule",
        // canActivate: [AuthGuard],
        // data: { roles: ["Admin"] }
      },
      {
        path: "agent/:pageName/:RandomNo", 
        loadChildren: "./pages/agent-pages/agent-read-more/agent-read-more.module#AgentReadMoreModule",
        // canActivate: [AuthGuard],
        // data: { roles: ["Admin"] }
      },
