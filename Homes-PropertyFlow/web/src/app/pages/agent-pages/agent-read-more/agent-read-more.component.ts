...
@Component({
  selector: 'app-agent-read-more',
  templateUrl: './agent-read-more.component.html',
  styleUrls: ['./agent-read-more.component.css']
})
export class AgentReadMoreComponent implements OnInit,AfterViewInit {
