...
export class SearchResultPageService {
  ...
  getHotPropertyFlowInterestByDaily(PropertyDetailIds: any[]) {
    let q = "PropertyDetailIds=" + PropertyDetailIds;
    return this.httpClient.get("/PropertyFlowInterestDaily/GetHotPropertyFlowInterest?" + q);
}
}
