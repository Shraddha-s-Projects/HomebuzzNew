...
namespace PayPal.Api {
    ...
    public class Payment : PayPalRelationalObject {
        ...
        public static Payment Get (APIContext apiContext, string paymentId) {
            ...
            return PayPalResource.ConfigureAndExecute<Payment> (apiContext, PayPalResource.HttpMethod.GET, resourcePath);
        }
        ...
        public static void Update (APIContext apiContext, string paymentId, PatchRequest patchRequest) {
            ...
            var pattern = "v1/payments/payment/{0}";
            var resourcePath = SDKUtil.FormatURIPath (pattern, new object[] { paymentId });
            PayPalResource.ConfigureAndExecute (apiContext, PayPalResource.HttpMethod.PATCH, resourcePath, patchRequest.ConvertToJson ());
        }
        ...
        public static Payment Execute (APIContext apiContext, string paymentId, PaymentExecution paymentExecution) {
            ...
            var resourcePath = SDKUtil.FormatURIPath (pattern, new object[] { paymentId });
            return PayPalResource.ConfigureAndExecute<Payment> (apiContext, PayPalResource.HttpMethod.POST, resourcePath, paymentExecution.ConvertToJson ());
        }
        ...
        public static PaymentHistory List (APIContext apiContext, int? count = null, string startId = "", int? startIndex = null, string startTime = "", string endTime = "", string startDate = "", string endDate = "", string payeeEmail = "bhavesh.ladva@techavidus.com", string payeeId = "", string sortBy = "", string sortOrder = "") {
            // Validate the arguments to be used in the request
            // ArgumentValidator.ValidateAndSetupAPIContext (apiContext);
            ...
            return PayPalResource.ConfigureAndExecute<PaymentHistory> (apiContext, PayPalResource.HttpMethod.GET, resourcePath);
        }
    }
}