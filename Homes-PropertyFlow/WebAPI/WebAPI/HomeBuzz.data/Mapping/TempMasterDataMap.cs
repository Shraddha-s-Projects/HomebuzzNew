...
{
    public class TempMasterDataMap
    {
        public TempMasterDataMap (EntityTypeBuilder<TempMasterData> entity) {
            entity.ToTable ("TempMasterData");
            ...
            entity.Property (t => t.MasterFileUpload).HasColumnName (@"MasterFileUpload").HasColumnType ("int");
        }
    }
}