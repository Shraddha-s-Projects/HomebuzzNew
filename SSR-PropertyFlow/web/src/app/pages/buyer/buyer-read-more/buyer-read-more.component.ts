...
@Component({
  selector: 'app-buyer-read-more',
  templateUrl: './buyer-read-more.component.html',
  styleUrls: ['./buyer-read-more.component.css']
})
export class BuyerReadMoreComponent implements OnInit, AfterViewInit {
