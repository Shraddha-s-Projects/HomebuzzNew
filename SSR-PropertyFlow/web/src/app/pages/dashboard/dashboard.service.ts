...
export class DashboardService {
  ...
  updateUserIdBasedOnUserKey(modal: any) {
    return this.httpClient.post("/PropertyView/UpdateUserIdBasedOnUserKey", modal);
  }

  CreatePayment(modal: any) {
    return this.httpClient.post("/Payment/CreatePayment", modal);
  }
}
