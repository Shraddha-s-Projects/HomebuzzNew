...
export class PropertyImageGalleryService {
    ...
    getTimeWeightedPropertyFlowInterestByHourly(PropertyDetailId) {
        let q = "PropertyDetailId=" + PropertyDetailId;
        return this.httpClient.get("/TimeWeightedPropertyFlowInterestHourly/GetPropertyFlowInterest?" + q);
    }

    getTimeWeightedPropertyFlowInterestByDaily(PropertyDetailId) {
        let q = "PropertyDetailId=" + PropertyDetailId;
        return this.httpClient.get("/TimeWeightedPropertyFlowInterestDaily/GetPropertyFlowInterest?" + q);
    }

    getTimeWeightedPropertyFlowInterestByWeekly(PropertyDetailId) {
        let q = "PropertyDetailId=" + PropertyDetailId;
        return this.httpClient.get("/TimeWeightedPropertyFlowInterestWeekly/GetPropertyFlowInterest?" + q);
    }
