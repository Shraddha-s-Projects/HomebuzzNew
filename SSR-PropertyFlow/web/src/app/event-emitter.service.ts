...
export class EventEmitterService {
  ...
  sortedPropertiesEmit = new EventEmitter();
  propertyDetailIncreaseViewCountEmit = new EventEmitter();
  ...
  OnSortedProperties(properties: any[], isHotPropeties: boolean, hotPropertyCount:number) {
    let Obj = {};
    Obj["Properties"] = properties;
    Obj["isHotPropeties"] = isHotPropeties;
    Obj["HotPropertyCount"] = hotPropertyCount;
    this.sortedPropertiesEmit.emit(Obj);
  }

  OnPropertyDetailIncreseViewCountAfter3secEmit(PropertyDetailId: number) {
    this.propertyDetailIncreaseViewCountEmit.emit(PropertyDetailId);
  }
}
