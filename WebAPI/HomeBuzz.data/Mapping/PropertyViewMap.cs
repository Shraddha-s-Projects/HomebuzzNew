...
namespace HomeBuzz.data.Mapping
{
    public class PropertyViewMap
    {
        public PropertyViewMap(EntityTypeBuilder<PropertyView> entity)
        {
            ...
            entity.Property(t => t.TimeWeightedViewDate).HasColumnName(@"TimeWeightedViewDate").HasColumnType("datetime");
            entity.Property(t => t.TimeWeightedUserKey).HasColumnName(@"TimeWeightedUserKey").HasColumnType("nvarchar(150)");
        }
    }
}
