...
{
    public class PropertyCrudDataMap
    {
         public PropertyCrudDataMap (EntityTypeBuilder<PropertyCrudData> entity) {
            entity.ToTable ("PropertyCrudData");
            ...
            entity.Property (t => t.AskingPrice).HasColumnName (@"AskingPrice").HasColumnType ("decimal(18,2)");
