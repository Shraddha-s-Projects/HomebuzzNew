CREATE PROCEDURE [dbo].[GETSUBHURBPROPERTIESFORMAP]
...
BEGIN
	...
	LEFT JOIN PropertyDetail pd ON p.PropertyDetailId = pd.Id and pd.IsActive = 1 and pd.PropertyId != @propertyId
