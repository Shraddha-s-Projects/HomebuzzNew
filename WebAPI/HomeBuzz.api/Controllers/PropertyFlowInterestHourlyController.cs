...
namespace HomeBuzz.api.Controllers {
    ...
    [Route ("api/PropertyFlowInterestHourly")]
    public class PropertyFlowInterestHourlyController : Controller {
        ...
        public PropertyFlowInterestHourlyController (
        ...
        public async Task<OperationResult<List<PropertyFlowInterestVM>>> GetPropertyFlowInterestByHourly (int PropertyDetailId) {
            try {
                var PropertyFlowInterestHourlyList = _propertyFlowInterestHourlyService.GetAllPropertyFlowInterestByPropertyDetailIdLast24Hours (PropertyDetailId);
                ...
                if (PropertyFlowInterestHourlyList.Count > 0) {
                    PropertyFlowInterestHourlyObj = PropertyFlowInterestHourlyList[0];
                }
                ...
                if (PropertyFlowInterestHourlyList.Count >= 24) {
                    // foreach (var item in PropertyFlowInterestHourlyList) {
                    ...
                    for (int i = hours; i >= 0;) {
                        ...
                        var carts = PropertyFlowInterestHourlyList.Where (t => t.CreatedOn > fromDate && t.CreatedOn <= toDate).ToList ();
                        PropertyFlowInterestVM propertyFlowInterestVMObj = new PropertyFlowInterestVM ();
                        if (carts.Count == 0) {
                ...
                if (PropertyFlowInterestHourlyList.Count < 24 && PropertyFlowInterestHourlyList.Count > 0) {
